...
public class Employee_Record extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Employee_Record\",\"namespace\":\"Avro.avro\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"joining_date\",\"type\":\"string\"},{\"name\":\"role\",\"type\":\"string\"},{\"name\":\"dept\",\"type\":[\"null\",\"string\"]},{\"name\":\"salary\",\"type\":\"float\"}]}");
  ...
  public static Avro.GenerateAvro.Employee_Record.Builder newBuilder() {
    return new Avro.GenerateAvro.Employee_Record.Builder();
  }

  /** Creates a new Employee_Record RecordBuilder by copying an existing Builder */
  public static Avro.GenerateAvro.Employee_Record.Builder newBuilder(Avro.GenerateAvro.Employee_Record.Builder other) {
    return new Avro.GenerateAvro.Employee_Record.Builder(other);
  }

  /** Creates a new Employee_Record RecordBuilder by copying an existing Employee_Record instance */
  public static Avro.GenerateAvro.Employee_Record.Builder newBuilder(Avro.GenerateAvro.Employee_Record other) {
    return new Avro.GenerateAvro.Employee_Record.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Employee_Record>
    ...
    private Builder() {
      super(Avro.GenerateAvro.Employee_Record.SCHEMA$);
    }

    /** Creates a Builder by copying an existing Builder */
    private Builder(Avro.GenerateAvro.Employee_Record.Builder other) {
      super(other);
    ...
    private Builder(Avro.GenerateAvro.Employee_Record other) {
            super(Avro.GenerateAvro.Employee_Record.SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'name' field */
    public Avro.GenerateAvro.Employee_Record.Builder setName(java.lang.CharSequence value) {
    ...
    public Avro.GenerateAvro.Employee_Record.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'joining_date' field */
    public Avro.GenerateAvro.Employee_Record.Builder setJoiningDate(java.lang.CharSequence value) {
    ...
    public Avro.GenerateAvro.Employee_Record.Builder clearJoiningDate() {
      joining_date = null;
    ...
    /** Sets the value of the 'role' field */
    public Avro.GenerateAvro.Employee_Record.Builder setRole(java.lang.CharSequence value) {
    ...
    public Avro.GenerateAvro.Employee_Record.Builder clearRole() {
      role = null;
    ...
    /** Sets the value of the 'dept' field */
    public Avro.GenerateAvro.Employee_Record.Builder setDept(java.lang.CharSequence value) {
    ...
    public Avro.GenerateAvro.Employee_Record.Builder clearDept() {
      dept = null;
    ...
    /** Sets the value of the 'salary' field */
    public Avro.GenerateAvro.Employee_Record.Builder setSalary(float value) {
    ...
    public Avro.GenerateAvro.Employee_Record.Builder clearSalary() {
